...
/**
 * @see ReferenceIdentifierConflictResolverForType
 */
public interface ReferenceIdentifierConflictResolverForCallback extends ReferenceIdentifierConflictResolverForType<Callback> {
