...
public class DefaultJacksonPolymorphismTypeSchemaNameBuilder implements JacksonPolymorphismTypeSchemaNameBuilder {

    public static final String SCHEMA_NAME_SUFFIX = "Type";
