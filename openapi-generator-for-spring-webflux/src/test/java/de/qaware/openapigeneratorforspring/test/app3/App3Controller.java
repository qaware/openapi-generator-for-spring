...
//    @PostMapping(value = "/mapping-3", consumes = MediaType.APPLICATION_JSON_VALUE)
//    public Mono<SomeDto> mapping3(@RequestBody @Schema(description = "request body DTO") SomeDto someDto) {
//        return null;
//    }
